...
void main()
{
    ...
    itemproperty iPF = ItemPropertyDamageBonus(IP_CONST_DAMAGETYPE_ACID,IP_CONST_DAMAGEBONUS_1d4);
    itemproperty iVis = ItemPropertyVisualEffect(ITEM_VISUAL_ACID);
