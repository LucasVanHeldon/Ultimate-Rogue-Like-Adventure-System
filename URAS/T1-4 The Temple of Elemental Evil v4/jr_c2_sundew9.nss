//  hcr3
// added change to set spawn location for npcs
// thanks Elric.
//:://////////////////////////////////////////////////
//:: NW_C2_DEFAULT9
/*
...
void main()
{
    ...
    */
    ...
    // hcr3 change to allow respawn to happen in same spot without waypoints.
    SetLocalLocation(OBJECT_SELF,"spawn",GetLocation(OBJECT_SELF));

    //***Giant Sundew Visual Properties***
    //Gives the creature a visual effect on Spawn
    //NWScript:
    //Axe Murderer
    //Posted: Sunday, 30 May 2004 05:06AM
    // Captain's OnSpawn script.
    //Edited by: JayAre
    //Edited on: Saturday, 03 July 2004 09:06PM

    effect eSundew = SupernaturalEffect( EffectVisualEffect( VFX_DUR_TENTACLE));
    ApplyEffectToObject( DURATION_TYPE_PERMANENT, eSundew, OBJECT_SELF);
