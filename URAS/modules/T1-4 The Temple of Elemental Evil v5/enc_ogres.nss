...
string sCR7="ogre022";
string sCR8="ogre023,ogre004";
string sCR9="ogre019,x3_ogrechief001";
string sCR10="ogre020,ogre005";
string sCR11="zep_dlaogre_001";
string sCR12="nw_ogreboss";
string sCR14="ogre021,ogre006";
string sCR21="nw_ogremageboss";
...
void Fill(int CR,object o = OBJECT_SELF)
{
    ...
    case 21:    PopulateVars(o, CR ,sCR21 );break;
    }
}
...
void main()
{
    SendMessageToPC(GetFirstPC(),"ENC Ogres");
