...
//Created August 15, 2002 by Edward Beck (0100010).
    ...
    string DONOTCONSUME = "This looks foul and you decide not to consume it.";
    ...
    string CANTEENSPOT = "You could fill a canteen here.";
    string POISON = "The water looks poisoned.";
    string DISEASE="The water looks diseased.";
    string CANFILLCANTEEN="You could fill your canteen here.";
    string REFRESHING="The water looks very refreshing.";
