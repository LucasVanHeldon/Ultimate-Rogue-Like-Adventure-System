...
if(GetHasSpell(SPELL_HEALINGKIT)) {ActionCastSpellAtObject(SPELL_HEALINGKIT,oTarget); return 1;}
...
if(GetHasSpell(SPELL_HORSE_ASSIGN_MOUNT)) {ActionCastSpellAtObject(SPELL_HORSE_ASSIGN_MOUNT,oTarget); return 1;}
if(GetHasSpell(SPELL_HORSE_DISMOUNT)) {ActionCastSpellAtObject(SPELL_HORSE_DISMOUNT,oTarget); return 1;}
if(GetHasSpell(SPELL_HORSE_MENU)) {ActionCastSpellAtObject(SPELL_HORSE_MENU,oTarget); return 1;}
if(GetHasSpell(SPELL_HORSE_MOUNT)) {ActionCastSpellAtObject(SPELL_HORSE_MOUNT,oTarget); return 1;}
if(GetHasSpell(SPELL_HORSE_PARTY_DISMOUNT)) {ActionCastSpellAtObject(SPELL_HORSE_PARTY_DISMOUNT,oTarget); return 1;}
if(GetHasSpell(SPELL_HORSE_PARTY_MOUNT)) {ActionCastSpellAtObject(SPELL_HORSE_PARTY_MOUNT,oTarget); return 1;}
...
if(GetHasSpell(SPELL_IDENTIFY)) {ActionCastSpellAtObject(SPELL_IDENTIFY,oTarget); return 1;}
...
if(GetHasSpell(SPELL_KOBOLD_JUMP)) {ActionCastSpellAtObject(SPELL_KOBOLD_JUMP,oTarget); return 1;}
...
if(GetHasSpell(SPELL_LIGHT)) {ActionCastSpellAtObject(SPELL_LIGHT,oTarget); return 1;}
...
if(GetHasSpell(SPELL_TRAP_ARROW)) {ActionCastSpellAtObject(SPELL_TRAP_ARROW,oTarget); return 1;}
if(GetHasSpell(SPELL_TRAP_BOLT)) {ActionCastSpellAtObject(SPELL_TRAP_BOLT,oTarget); return 1;}
if(GetHasSpell(SPELL_TRAP_DART)) {ActionCastSpellAtObject(SPELL_TRAP_DART,oTarget); return 1;}
if(GetHasSpell(SPELL_TRAP_SHURIKEN)) {ActionCastSpellAtObject(SPELL_TRAP_SHURIKEN,oTarget); return 1;}
if(GetHasSpell(SPELL_TRUE_SEEING)) {ActionCastSpellAtObject(SPELL_TRUE_SEEING,oTarget); return 1;}
if(GetHasSpell(SPELL_TRUE_STRIKE)) {ActionCastSpellAtObject(SPELL_TRUE_STRIKE,oTarget); return 1;}
