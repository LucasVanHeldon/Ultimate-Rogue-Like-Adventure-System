...
string NEEDKEY = "You need a specific key to open this lock.";
string MUSTEQUIP = "You must equip the thieves' tools to use.";
string NOTRAISE = "Player is not ressable at this time..wait for the Gods to release thier soul";
string SKINNING= " Skins Animal*";
// 5.5
string SPILLCONTENTS = "You spill some of the contents of your Healkit on the ground";
