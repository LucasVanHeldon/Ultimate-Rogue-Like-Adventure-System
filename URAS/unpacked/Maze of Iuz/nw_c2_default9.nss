...
void main()
{
    ...
    float dice = IntToFloat(Random(10000))/10000.0;
        ...
        if(GetAbilityScore(OBJECT_SELF,ABILITY_INTELLIGENCE) > 5)
        {
            ...
            */
                ...
                rt != RACIAL_TYPE_UNDEAD)
            {
                ...
                dice = IntToFloat(Random(10000))/10000.0;
                int chance = FloatToInt(dice*10000.0);

                if(chance <= iSocketLootChance)
