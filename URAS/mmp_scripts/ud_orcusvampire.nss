...
void VAMPIRE_SpecialAttack()
{
    ...
    case 2:
    {
          ...
          if(D > 2.0 && D < 15.0)
          {
            ...
            if(!GetIsObjectValid(oMax)) oMax = PickEnemy(OBJECT_SELF);
...
void ORCUSSPAWN_SpecialAttack()
{
    switch(d6())
    {
    case 1:
    case 2:
    case 3: VAMPIRE_SpecialAttack(); break;
    case 4:
    case 5:
    case 6: DEMONIC_SpecialAttack(); break;
    }
}
