// Morbid - Sorcery/Necromancy
// Dark Template - CLeric/Divine corruption
// Unholy - Morbid+Dark
// Heretitcal - Morbid+Dark+Demonic
// Fallen - Demonic+Dark
// Aberrant - Morbid+Aberration
// Abomination - Unholy+Aberration
// Blasphemous - Heretic+Aberration
// Eldtritch - Wizardry+Morbid/Aberration/Lich
...
void MMP_ApostateTemplate(object oSkin)
{
    int die = Die(25);
    int nEffect;
...
void main()
{
    ...
    */
    ...
    for(i = 0; i < GetHitDice(OBJECT_SELF); i++) MMP_ApostateTemplate(oSkin);
    ...
    for(i = 0; i < 2+d4(); i++)
        CreateObject(OBJECT_TYPE_CREATURE,"nw_ghast",GetLocation(OBJECT_SELF));
